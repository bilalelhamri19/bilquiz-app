      ...
      <article className="glass mx-auto max-w-3xl rounded-3xl p-6 sm:p-10">
        ...
        <section className="mt-8 space-y-4 leading-8 text-white/75">
          ...
          <div>
            ...
            <p>
              يستخدم الموقع خطوط Google Fonts لعرض النصوص. قد تتلقى Google معلومات تقنية معتادة مثل عنوان IP وبيانات الطلب عند تحميل الخطوط، وفقاً لسياسة خصوصيتها. لا يستخدم BilQuiz الإعلانات أو أدوات التحليلات أو أدوات التتبع.
            </p>
          </div>
