  ...
  <>
    ...
    <main className="flex-1 px-4 py-10 text-right text-white">
      <article className="glass mx-auto max-w-3xl rounded-3xl p-6 sm:p-10">
        <h1 className="text-3xl font-black">سياسة الخصوصية لتطبيق BilQuiz</h1>
        ...
        <section className="mt-8 space-y-4 leading-8 text-white/75">
          ...
          <div>
            ...
            <p>
              يحتفظ BilQuiz محلياً على جهازك فقط بتقدمك في اللعبة وعدد النقاط. لا نرسل هذه المعلومات إلى خادم تابع لنا ولا نبيعها أو نشاركها مع جهات أخرى.
            </p>
          </div>
